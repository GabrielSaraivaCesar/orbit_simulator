...
DRAW_PATHES=True
# DRAW_UNIVERSE_CENTER_OF_MASS=True
# DRAW_LINE_TO_UNIVERSE_CENTER_OF_MASS=False
...
ANIMATION_FIXED_DELTA_TIME=0.001 # Lower values increases precision and decreases simulation speed